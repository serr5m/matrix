...
TEST(TestEqMatrix, Test0) {
  ...
  myMatrix a(2, 2, array1);
  myMatrix b(2, 2, array1);
...
TEST(TestEqMatrix, Test2) {
  ...
  myMatrix a(2, 3, array1);
  myMatrix b(2, 3, array2);
  ASSERT_FALSE(a.EqMatrix(b));
}
TEST(TestOperatorEqual, Test0) {
  myMatrix a(3, 2, {1, 2, 3, 4, 5, 6});
  myMatrix b;
  b = a;
  ASSERT_TRUE(a.EqMatrix(b));
}
...
TEST(TestSumMatrix, Test0) {
  ...
  myMatrix a(2, 3, array1);
  myMatrix b(2, 3, array1);
  myMatrix res(2, 3, res_array);
  a.SumMatrix(b);
...
TEST(TestOperatorPlus, Test0) {
  myMatrix a(2, 2, {0, 1, 2, 3});
  myMatrix b(2, 2, {1, 2, 3, 4});
  myMatrix c = a + b;
...
TEST(TestSubMatrix, Test0) {
  ...
  myMatrix a(3, 3, array);
  myMatrix b(3, 3, array);
...
TEST(TestOperatorMulNumber, Test0) {
  myMatrix a(2, 3, {3.23, 9.12, -4, 0.008, 3.01, 44});
  double b = 0.5;
  a *= b;
...
TEST(TestTranspose, Test0) {
  myMatrix a(2, 3, {1, 2, 3, 4, 5, 6});
  myMatrix b(3, 2, {1, 4, 2, 5, 3, 6});
  ASSERT_TRUE(a.Transpose().EqMatrix(b));
}
TEST(TestTranspose, Test1) {
  myMatrix a(2, 2, {1, 2, 3, 4});
  myMatrix b(2, 2, {1, 3, 2, 4});
  ASSERT_TRUE(a.Transpose().EqMatrix(b));
}
